...
public class SandboxConjuntos
{
    ...
    public String getPrimera( )
    {
    	...
    	String respuesta = arbolCadenas.first();
        return respuesta;
    }
    ...
    public String getUltima( )
    {
    	...
    	String respuesta = arbolCadenas.descendingSet().first();
        return respuesta;
    }
    ...
    {
    	TreeSet<String> nuevo = new TreeSet<String>(arbolCadenas);
    	nuevo.descendingSet();
        return nuevo;
    }
