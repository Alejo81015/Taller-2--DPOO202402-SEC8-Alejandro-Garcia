...
List <String> llaves = new ArrayList <> (mapaCadenas.keySet());
    	...
    	Collections.sort(llaves,Comparator.reverseOrder());
        return llaves;
    }
    ...
    public String getUltima( )
    {
    	...
    	Collections.sort(valores);
    	String respuesta= valores.get(valores.size()-1);
            return respuesta;
    ...
    public Collection<String> getLlaves( )
    {
    	...
    	for (int i=0;i<llaves.size();i++) {
    		String llaveC= llaves.get(i);
    		llaves.set(i, llaveC.toUpperCase());
    	}
        return llaves;
    }
    ...
    public void eliminarCadenaConValor( String valor )
    {
    	...
    	int i =0;
    	String llaveBuscada="";
    	while(i<llaves.size() && encontro==false) {
    		String valorB=mapaCadenas.get(llaves.get(i));
    		if (valorB==valor) {
    			encontro=true;
    			llaveBuscada=llaves.get(i);
    		}
    		
    				
    		i++;
    	}
    	mapaCadenas.remove(llaveBuscada, valor);
    }
    ...
    public void volverMayusculas( )
    {
         ...
         for (Map.Entry<String, String> entry : mapaCadenas.entrySet()) {
             ...
             nuevo.put(llaveMayuscula, valor);
